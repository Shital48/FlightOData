		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comflightflightodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comflightflightodata-display": {
								"semanticObject": "comflightflightodata",
								"action": "display",
								"description": "Access Flight Odata  ",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.flight.flightodata",
									"url": sap.ui.require.toUrl("com/flight/flightodata")
								}
							}
						}
					}
